...
function NotificationContent() {
  return (
    <div
      ...
      data-name="notification-content"
    >
      <div
        className="pointer-events-none relative rounded-[200px] shrink-0 size-[48px]"
        data-name="notification-time"
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[514.44%] left-[-108.64%] max-w-none top-[-86.62%] w-[342.96%]"
            src={imgNotificationTime}
          />
        </div>
        <div
          aria-hidden="true"
          className="absolute border border-[#c8bbda] border-solid inset-[-0.5px] rounded-[200.5px]"
        />
      </div>
...
function NotificationItem() {
  return (
    <div
      className="bg-[#f7f4fa] relative shrink-0 w-full"
...
function NotificationContent1() {
  return (
    ...
    >
      <div
        className="pointer-events-none relative rounded-[8px] shrink-0 size-[48px]"
        data-name="notification-time"
      >
        <div className="absolute inset-0 overflow-hidden rounded-[8px]">
          <img
            alt=""
            className="absolute h-full left-[-37.05%] max-w-none top-[-0.14%] w-[178.57%]"
            src={imgNotificationTime1}
          />
        </div>
        <div
          aria-hidden="true"
          className="absolute border border-[#c8bbda] border-solid inset-0 rounded-[8px]"
        />
      </div>
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#433059] text-[16px]">
        <p className="leading-[24px]">
...
function NotificationsScreen() {
  return (
    <div
      className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[16px] items-start left-1/2 max-w-[800px] min-w-[360px] py-[20px] top-[108px] w-[390px]"
      data-name="notifications-screen"
    >
      <SectionHeader />
      <NotificationsList />
    </div>
...
function TopBar() {
  return (
    <div
      className="absolute bg-[#fffeff] content-stretch flex flex-col items-start left-0 right-0 top-0"
      data-name="top-bar"
    >
      <StatusBar />
