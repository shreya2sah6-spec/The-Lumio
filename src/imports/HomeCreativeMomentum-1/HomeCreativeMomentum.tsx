...
function ProgressFill() {
  return (
    <div className="-translate-y-1/2 absolute h-[4px] left-0 right-[42.31%] rounded-[200px] top-1/2" data-name="progress-fill">
      <div className="absolute bg-[#7d3aea] h-[4px] left-0 right-[0.35%] rounded-[200px] top-0" data-name="inner-line" />
    </div>
  );
}
...
function StoryProgress() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="story-progress">
      <div className="flex-[1_0_0] h-[4px] min-w-px overflow-clip relative rounded-[200px]" data-name="progress-segment">
        <div className="-translate-y-1/2 absolute bg-white border-[#e2d9ef] border-[0.2px] border-solid h-[4px] left-0 right-0 rounded-[200px] top-1/2" data-name="progress-track" />
        <ProgressFill />
      </div>
      <div className="bg-white flex-[1_0_0] h-[4px] min-w-px overflow-clip relative rounded-[200px]" data-name="progress-segment">
        <div className="absolute bg-white border-[#e2d9ef] border-[0.2px] border-solid h-[4px] left-0 right-0 rounded-[200px] top-0" data-name="progress-track" />
      </div>
      <div className="bg-white flex-[1_0_0] h-[4px] min-w-px overflow-clip relative rounded-[200px]" data-name="progress-segment">
        <div className="absolute bg-white border-[#e2d9ef] border-[0.2px] border-solid h-[4px] left-0 right-0 rounded-[200px] top-0" data-name="progress-track" />
      </div>
...
function BackButton() {
  return (
    <div className="backdrop-blur-[2px] bg-white content-stretch flex items-center p-[8px] relative rounded-[200px] shrink-0" data-name="back-button">
      <div aria-hidden="true" className="absolute border border-[#e2d9ef] border-solid inset-0 pointer-events-none rounded-[200px]" />
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="chevron-icon">
        <div className="absolute inset-[15.62%_34.37%_15.62%_28.12%]" data-name="Svg">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.00101 16.5008">
            <path d={svgPaths.p3289c580} fill="var(--fill-0, #6B5F7A)" id="Svg" />
          </svg>
        </div>
      </div>
    </div>
...
function Views() {
  return (
    <div className="bg-[rgba(26,26,26,0.6)] content-stretch flex gap-[4px] items-center px-[8px] py-[4px] relative rounded-[4px] shrink-0" data-name="views">
      <Eye />
...
function TopBar() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[24px] items-start left-1/2 max-w-[800px] px-[16px] py-[24px] top-0 w-[390px]" data-name="top-bar">
      <StoryProgress />
      <Action />
    </div>
  );
...
function Content() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[20px] items-start justify-end leading-[0] relative shrink-0 text-center text-white w-full" data-name="content">
      ...
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[14px] w-full">
        <p className="leading-[21px]">Runways from New York to Paris are embracing expressive florals again from sculpted petals to soft botanical prints. The trend signals a shift toward more emotional, feel-good fashion storytelling.</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-white content-stretch flex items-center p-[8px] relative rounded-[200px] shrink-0" data-name="button">
...
function BottomOverlay() {
  return (
    <div className="-translate-x-1/2 absolute bottom-0 content-stretch flex flex-col gap-[32px] items-center justify-end left-1/2 max-w-[800px] px-[16px] py-[32px] w-[390px]" data-name="bottom-overlay">
      <Content />
      <Button />
    </div>
  );
...
function HomeCreativeMomentumScreenContent() {
  return (
    <div className="absolute h-[754px] left-0 top-[44px] w-[390px]" data-name="home/creative-momentum-screen-content">
      <div className="-translate-y-1/2 absolute aspect-[1560/3028] left-0 right-0 top-[calc(50%-0.5px)]" data-name="creative-card-01">
...
function StatusBar() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#fffeff] content-stretch flex h-[44px] items-center justify-between left-1/2 overflow-clip px-[16px] py-[8px] top-0 w-[390px]" data-name="status-bar">
...
export default function HomeCreativeMomentum() {
  return (
    <div className="bg-[#fffeff] relative size-full" data-name="home/creative-momentum">
