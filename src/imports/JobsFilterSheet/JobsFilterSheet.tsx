import svgPaths from "./svg-cifqeuh4k9";

function Handel() {
  return (
    <div className="relative shrink-0 w-full" data-name="handel">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center p-[16px] relative size-full">
          <div
            className="bg-[#1a1128] h-[4px] relative rounded-[24px] shrink-0 w-[32px]"
            data-name="svg"
          />
        </div>
      </div>
    ...
    <div className="relative shrink-0 w-full" data-name="header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[12px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-px relative text-[#2d2040] text-[18px] text-center">
...
function PrimaryFilters() {
  return (
    <div className="relative shrink-0 w-full" data-name="primary-filters">
      <div
        aria-hidden="true"
        className="absolute border-[#c8bbda] border-b border-solid inset-0 pointer-events-none"
      />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch cursor-pointer flex gap-[12px] items-center p-[16px] relative size-full">
          <button
            className="bg-[#b090ef] content-stretch flex h-[40px] items-center justify-center px-[16px] py-[12px] relative rounded-[12px] shrink-0"
            data-name="primary-chip-filter-sheet"
          >
            <div
              aria-hidden="true"
              className="absolute border border-[#7d3aea] border-solid inset-0 pointer-events-none rounded-[12px]"
            />
          ...
          <button
            className="bg-white content-stretch flex h-[40px] items-center justify-center px-[16px] py-[12px] relative rounded-[12px] shrink-0"
            data-name="primary-chip-filter-sheet"
          >
            <div
              aria-hidden="true"
...
function SecondaryFilters() {
  return (
    <div className="relative shrink-0 w-full" data-name="secondary-filters">
      <div className="flex flex-row items-center size-full">
        <div className="content-center cursor-pointer flex flex-wrap gap-[12px] items-center px-[16px] py-[12px] relative size-full">
          <button
            className="bg-white content-stretch flex gap-[8px] items-center justify-center max-h-[44px] min-h-[44px] px-[16px] py-[12px] relative rounded-[8px] shrink-0"
            data-name="tab/chip"
          >
            <div
              aria-hidden="true"
            ...
            >
              <div
                className="absolute bottom-[18.75%] left-[12.5%] right-[9.37%] top-1/4"
                data-name="svg"
              >
                <svg
          ...
          <button
            className="bg-white content-stretch flex items-center justify-center max-h-[44px] min-h-[44px] px-[16px] py-[12px] relative rounded-[8px] shrink-0"
            data-name="tab/chip"
          >
            <div
              aria-hidden="true"
          ...
          >
            ...
            />
            <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#6b5f7a] text-[16px] text-center text-ellipsis whitespace-nowrap">
              <p className="leading-[24px] overflow-hidden text-ellipsis">{`Stylist `}</p>
            </div>
          </button>
          <button
            className="bg-white content-stretch flex items-center justify-center max-h-[44px] min-h-[44px] px-[16px] py-[12px] relative rounded-[8px] shrink-0"
...
function Footer() {
  return (
    <div
      className="max-w-[800px] min-w-[360px] relative shrink-0 w-full"
      data-name="footer"
    >
      <div className="content-stretch flex gap-[16px] items-start max-w-[inherit] min-w-[inherit] pb-[24px] pt-[12px] px-[16px] relative size-full">
        ...
        >
          <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[16px] text-center tracking-[0.48px] whitespace-nowrap">
            <p className="leading-[20px]" style={{ color: "#7D3AEA" }}>Clear All</p>
          </div>
        </div>
        <div
...
export default function JobsFilterSheet() {
  return (
    <div
      className="bg-white content-stretch flex flex-col items-start justify-end overflow-clip relative rounded-tl-[24px] rounded-tr-[24px] shadow-[0px_-1px_4px_0px_rgba(26,26,26,0.6)] size-full"
      data-name="jobs/filter-sheet"
    >
      <Handel />
      <Header />
      <PrimaryFilters />
