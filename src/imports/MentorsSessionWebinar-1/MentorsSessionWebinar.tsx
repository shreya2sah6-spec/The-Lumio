...
function Tab() {
  return (
    <div className="bg-white content-stretch flex h-[40px] items-center justify-center px-[16px] py-[12px] relative rounded-[4px] shrink-0" data-name="tab">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#6b5f7a] text-[16px] text-center text-ellipsis whitespace-nowrap">
        <p className="leading-[24px] overflow-hidden text-ellipsis">1:1 Sessions</p>
      </div>
    </div>
  );
}
...
function SessionTag() {
  return (
    <div className="bg-[#fef0d2] content-stretch flex items-center justify-center p-[8px] relative rounded-[2px] shrink-0" data-name="session-tag">
...
function Frame1() {
  return (
    <div className="content-stretch drop-shadow-[-2px_0px_2px_rgba(200,192,212,0.6)] flex items-center pointer-events-none relative shrink-0">
      <div className="mr-[-12px] relative rounded-[24px] shrink-0 size-[48px]" data-name="host-avatar">
      ...
      <div className="mr-[-12px] relative rounded-[200px] shrink-0 size-[48px]" data-name="host-avatar">
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img alt="" className="absolute h-[549.84%] left-[-190.48%] max-w-none top-[-186.01%] w-[731.97%]" src={imgHostAvatar1} />
        </div>
        <div aria-hidden="true" className="absolute border border-[#e2d9ef] border-solid inset-0 rounded-[200px]" />
      </div>
      <div className="relative rounded-[200px] shrink-0 size-[48px]" data-name="host-avatar">
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img alt="" className="absolute h-[560.42%] left-[-459.68%] max-w-none top-[-194.68%] w-[747.22%]" src={imgHostAvatar1} />
        </div>
        <div aria-hidden="true" className="absolute border border-[#e2d9ef] border-solid inset-0 rounded-[200px]" />
      </div>
    </div>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[2px] items-start justify-center leading-[0] relative shrink-0 text-[14px] text-left w-full whitespace-nowrap" data-name="host-details">
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center overflow-hidden relative shrink-0 text-[#1a1128] text-ellipsis tracking-[0.14px] w-full">
        <p className="leading-[21px] overflow-hidden text-ellipsis">Shruti Jain, Riya Raj, Ankita K</p>
      </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="sessions">
      <div className="content-stretch flex flex-col items-start px-[16px] py-[24px] relative size-full">
        <button className="bg-white cursor-pointer max-w-[768px] min-w-[320px] relative rounded-[4px] shrink-0 w-full" data-name="session-card">
...
export default function MentorsSessionWebinar() {
  return (
    <div className="bg-[#fffeff] relative size-full" data-name="mentors/session-webinar">
