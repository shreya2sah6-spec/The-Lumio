import svgPaths from "./svg-k7peoqe5w5";
    ...
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-center min-w-px relative">
      ...
      <div className="bg-[#fffeff] content-stretch flex flex-col gap-[12px] h-[40px] items-center justify-end max-h-[40px] pt-[12px] px-[16px] relative shrink-0" data-name="tab/chip">
        ...
        <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1a1128] text-[16px] text-center text-ellipsis tracking-[0.16px] whitespace-nowrap">
          <p className="leading-[25px] overflow-hidden text-ellipsis">Upcoming session</p>
        </div>
...
function Tab() {
  return (
    <div className="bg-[#f5f0ff] content-stretch flex h-[40px] items-center justify-center px-[16px] py-[12px] relative rounded-[4px] shrink-0" data-name="tab">
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] overflow-hidden relative shrink-0 text-[#2d2040] text-[16px] text-center text-ellipsis tracking-[0.16px] whitespace-nowrap">
        <p className="leading-[25px] overflow-hidden text-ellipsis">1:1 Sessions</p>
      </div>
    </div>
  );
}
...
function Tab1() {
  return (
    <div className="bg-white content-stretch flex h-[40px] items-center justify-center px-[16px] py-[12px] relative rounded-[4px] shrink-0" data-name="tab">
      <div aria-hidden="true" className="absolute border border-[#7d3aea] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#6b5f7a] text-[16px] text-center text-ellipsis whitespace-nowrap">
        <p className="leading-[24px] overflow-hidden text-ellipsis">Webinars</p>
      </div>
    </div>
  );
}
...
function MentorsSessioTabGround() {
  return (
    <div className="relative shrink-0 w-full" data-name="mentors/sessio/tab-ground">
...
function SessionTag() {
  return (
    <div className="bg-[#f4f7ff] content-stretch flex items-center justify-center p-[8px] relative rounded-[2px] shrink-0" data-name="session-tag">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#1a1128] text-[12px] text-center tracking-[0.24px] whitespace-nowrap">
        <p className="leading-[18px]">Learning</p>
      </div>
    </div>
  );
}
...
function HeaderContent() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start justify-center min-w-px relative" data-name="header-content">
      <SessionTag />
      <div className="[word-break:break-word] flex flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-full relative shrink-0 text-[#1a1128] text-[18px] text-left w-[min-content]">
        <p className="leading-[28px]">Your session starts in 00:10 minutes</p>
      </div>
    </div>
  );
}
...
function SessionHeader() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="session-header">
      <HeaderContent />
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="chevron-icon">
        <div className="absolute inset-[28.12%_15.62%_34.37%_15.62%]" data-name="Svg">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.501 9.00118">
            <path d={svgPaths.p3d97f870} fill="var(--fill-0, #6B5F7A)" id="Svg" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame1() {
  return (
    <div className="content-stretch drop-shadow-[-2px_0px_2px_rgba(200,192,212,0.6)] flex items-center relative shrink-0">
      <div className="pointer-events-none relative rounded-[24px] shrink-0 size-[48px]" data-name="host-avatar">
        <div className="absolute inset-0 overflow-hidden rounded-[24px]">
          <img alt="" className="absolute h-[311.69%] left-[-48.84%] max-w-none top-[-48.31%] w-[207.79%]" src={imgHostAvatar} />
        </div>
...
function ScheduleRow() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="schedule-row">
      <Frame1 />
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] min-w-px relative text-[#1a1128] text-[16px] text-left tracking-[0.16px]">
        <p className="leading-[25px]">Sat · 30 July, 6:00 PM – 7:00 PM</p>
      </div>
    </div>
  );
}
...
function HostDetails() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[2px] items-start justify-center leading-[0] relative shrink-0 text-[14px] text-left w-full whitespace-nowrap" data-name="host-details">
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center overflow-hidden relative shrink-0 text-[#1a1128] text-ellipsis tracking-[0.14px] w-full">
        <p className="leading-[21px] overflow-hidden text-ellipsis">Shruti Jain</p>
      </div>
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center overflow-hidden relative shrink-0 text-[#6b5f7a] text-ellipsis w-full">
        <p className="leading-[21px] overflow-hidden text-ellipsis">(Sr. Fashion Designer @Max Fashion)</p>
      </div>
    </div>
  );
}
...
function SessionMeta() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="session-meta">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="video-camera">
        <div className="-translate-y-1/2 absolute aspect-[22.5/13.5] left-[8.33%] right-[8.33%] top-1/2" data-name="svg">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 12">
            <path d={svgPaths.p2d857100} fill="var(--fill-0, #6B5F7A)" id="svg" />
          </svg>
        </div>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6b5f7a] text-[14px] text-left whitespace-nowrap">
        <p className="leading-[21px]">60mins</p>
      </div>
    </div>
  );
}
...
function MentorDetailsWithSessionData() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="mentor-details-with-session-data">
      <HostDetails />
      <SessionMeta />
    </div>
  );
...
function SessionDetails() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="session-details">
      <ScheduleRow />
...
function ActionGroup() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="action-group">
      <div className="bg-white flex-[1_0_0] h-[40px] max-h-[40px] min-h-[40px] min-w-px relative rounded-[4px]" data-name="primary-button">
        <div aria-hidden="true" className="absolute border border-[#7d3aea] border-solid inset-0 pointer-events-none rounded-[4px]" />
      ...
      <div className="bg-[#7d3aea] flex-[1_0_0] h-[40px] max-h-[40px] min-h-[40px] min-w-px relative rounded-[4px]" data-name="primary-button">
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[12px] py-[8px] relative size-full">
...
function SessionContent() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full" data-name="session-content">
      <SessionDetails />
      <ActionGroup />
    </div>
  );
...
function SessionTag1() {
  return (
    <div className="bg-[#d6f5dd] content-stretch flex items-center justify-center p-[8px] relative rounded-[2px] shrink-0" data-name="session-tag">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#1a1128] text-[12px] text-center tracking-[0.24px] whitespace-nowrap">
        <p className="leading-[18px]">Mentoring</p>
      </div>
    </div>
  );
}

function SessionHeader1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start justify-center min-w-px relative" data-name="session-header">
      <SessionTag1 />
      <div className="[word-break:break-word] flex flex-col font-['Manrope:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-w-full relative shrink-0 text-[#1a1128] text-[18px] text-left w-[min-content]">
        <p className="leading-[28px]">Session in 5 days</p>
      </div>
    </div>
  );
}
...
function Sessions() {
  return (
    <div className="max-w-[768px] min-w-[320px] relative shrink-0 w-full" data-name="sessions">
      <div className="content-stretch cursor-pointer flex flex-col gap-[12px] items-start max-w-[inherit] min-w-[inherit] px-[16px] py-[24px] relative size-full">
        <button className="bg-white max-w-[768px] min-w-[320px] relative rounded-[4px] shrink-0 w-full" data-name="session-card">
          ...
          <div aria-hidden="true" className="absolute border border-[#e2d9ef] border-solid inset-0 pointer-events-none rounded-[4px]" />
        </button>
        <button className="bg-white max-w-[768px] min-w-[320px] relative rounded-[4px] shrink-0 w-full" data-name="session-card">
          <div aria-hidden="true" className="absolute border border-[#e2d9ef] border-solid inset-0 pointer-events-none rounded-[4px]" />
          <div className="flex flex-row items-center max-w-[inherit] min-w-[inherit] size-full">
            <div className="content-stretch flex gap-[8px] items-center max-w-[inherit] min-w-[inherit] px-[16px] py-[12px] relative size-full">
              <SessionHeader1 />
              <div className="overflow-clip relative shrink-0 size-[24px]" data-name="chevron-icon">
                <div className="absolute inset-[34.37%_15.62%_28.12%_15.62%]" data-name="Svg">
                  <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.5008 9.00101">
                    <path d={svgPaths.p13567b00} fill="var(--fill-0, #6B5F7A)" id="Svg" />
                  </svg>
                </div>
              </div>
            </div>
...
function SessionsScreenContent() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-start left-1/2 max-w-[724px] min-w-[360px] top-[108px] w-[390px]" data-name="sessions-screen-content">
      <TabList />
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[4px] relative size-full">
          ...
          <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px overflow-hidden relative text-[#6b5f7a] text-[14px] text-ellipsis whitespace-nowrap">
            <p className="leading-[21px] overflow-hidden text-ellipsis">Search Sessions</p>
          </div>
        </div>
      </div>
    </div>
...
export default function MentorsSession1On() {
  return (
    <div className="bg-[#fffeff] relative size-full" data-name="mentors/session-1on1">
