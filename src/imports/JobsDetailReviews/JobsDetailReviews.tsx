            ...
            <ul className="list-disc">
              <li className="mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
                ...
                <span className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[21px] text-[#6b5f7a] text-[14px]">
                  The culture with opportunities to learn and grow.
                </span>
              </li>
              <li className="[word-break:break-word] leading-[21px] mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)] text-[14px]">
                <span className="font-['Manrope:Medium',sans-serif] font-medium tracking-[0.14px]">
                  Fast-paced work:
                </span>
                <span className="font-['Manrope:Regular',sans-serif] font-normal">{` `}</span>
                <span className="font-['Manrope:Regular',sans-serif] font-normal text-[#6b5f7a]">
                  The environment that can be demanding at times.
                </span>
              </li>
              <li className="[word-break:break-word] leading-[21px] ms-[calc(var(--list-marker-font-size,0)*1.5*1)] text-[14px]">
                ...
                <span className="font-['Manrope:Regular',sans-serif] font-normal text-[#6b5f7a]">
                  They focused on innovation, work–life balance, and employee
                  empowerment.
                </span>
              </li>
            </ul>
...
function AiReviewsSummary() {
  return (
    <div
      className="content-stretch drop-shadow-[0px_1px_2px_rgba(132,111,132,0.12)] flex flex-col items-start max-w-[768px] min-w-[320px] relative shrink-0 w-full"
      data-name="ai-reviews-summary"
    >
      <SectionHeader />
      <SectionContent />
    </div>
    ...
    <div className="relative shrink-0 size-[54px]" data-name="avatar">
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[204.79%] left-[-108.98%] max-w-none top-[-7.41%] w-[307.19%]"
            src={imgAvatarImage}
          />
        </div>
        <div
...
function ReviewerInfo() {
  return (
    <div
      className="content-stretch flex items-center py-[2px] relative shrink-0 w-[343px]"
...
function ReadMore() {
  return (
    <div
      className="content-stretch flex gap-[8px] h-[24px] items-center relative shrink-0"
      data-name="read-more"
    >
      ...
      >
        ...
        >
          <svg
            ...
            fill="none"
            preserveAspectRatio="none"
            viewBox="0 0 11.0006 6.00067"
          >
            <path
              d={svgPaths.p10c93a80}
...
function Reviews2() {
  return (
    <div
      className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[343px]"
      data-name="reviews"
    >
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full overflow-hidden relative shrink-0 text-[#433059] text-[16px] text-ellipsis w-[min-content]">
        <p className="leading-[24px]">
          I had a great experience working at this company, as the team was
          professional and supportive. The work environment encouraged learning,
          growth, and collaboration. Overall, it is a reliable and well-managed
          company with strong values and culture.
        </p>
      </div>
      <ReadMore />
    </div>
...
function ReviewHeader() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] items-start py-[4px] relative shrink-0 w-full"
  ...
  return (
    <div className="relative shrink-0 size-[54px]" data-name="avatar">
      ...
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-cover rounded-[200px] size-full"
          src={imgAvatarImage1}
        />
        <div
          aria-hidden="true"
...
function ReviewerDetails1() {
  return (
    <div
      className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[54px] items-start justify-center min-w-px relative"
      data-name="reviewer-details"
    >
...
function Reviews3() {
  return (
    ...
    >
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full overflow-hidden relative shrink-0 text-[#433059] text-[16px] text-ellipsis w-[min-content]">
        <p className="leading-[24px]">
          This company is deeply committed to the community. The work we do not
          only promotes business growth but also positively impacts society. I
          love being part of a team that shares values of social responsibility
          and collaboration.
        </p>
      </div>
      <ReadMore1 />
    ...
    <div className="relative shrink-0 size-[54px]" data-name="avatar">
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[255.56%] left-[-181.92%] max-w-none top-[-10.84%] w-[383.33%]"
            src={imgAvatarImage2}
          />
        </div>
        <div
...
function Reviews1() {
  return (
    ...
    >
      <div
        className="bg-[#fffeff] content-stretch flex flex-col items-start max-w-[768px] min-w-[320px] py-[12px] relative shrink-0 w-full"
    ...
    <div className="relative shrink-0 w-full" data-name="detailed-sections">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-center pb-[20px] pt-[16px] px-[16px] relative size-full">
          <Reviews />
          <div
            className="content-stretch flex gap-[8px] h-[48px] items-center justify-center max-h-[48px] min-h-[48px] px-[16px] py-[12px] relative rounded-[8px] shrink-0 w-[358px]"
...
function JobDetailsPage() {
  return (
    <div
      className="-translate-x-1/2 absolute bg-[#fffeff] content-stretch flex flex-col items-start left-1/2 max-w-[724px] min-w-[360px] top-[108px] w-[390px]"
...
function ActionGroup() {
  return (
    <div
      className="content-stretch flex gap-[16px] items-center pb-[24px] pt-[12px] relative shrink-0 w-full"
    ...
    >
      ...
      <div
        className="bg-gradient-to-r flex-[1_0_0] from-[#7d3aea] h-[48px] max-h-[48px] min-h-[48px] min-w-px relative rounded-[8px] to-[#5e28b5]"
        data-name="primary-button"
      >
        <div className="flex flex-row items-center justify-center max-h-[inherit] min-h-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center max-h-[inherit] min-h-[inherit] px-[16px] py-[12px] relative size-full">
