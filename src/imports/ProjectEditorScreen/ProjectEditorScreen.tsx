import svgPaths from "./svg-03efpi1kk3";
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col items-stretch py-[20px] relative flex-1 min-w-0" data-name="container">
      <div className="bg-[#c9b4f6] h-[2px] relative w-full" data-name="connector" />
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-stretch py-[20px] relative flex-1 min-w-0" data-name="container">
      <div className="bg-[#f5f0ff] h-[2px] relative w-full" data-name="connector" />
    </div>
  );
}
...
function MiddleStep() {
  return (
    <div className="content-stretch flex flex-1 items-start min-w-0 relative" data-name="middle-step">
      <Container1 />
      <div className="content-stretch flex flex-col h-[63px] items-center justify-center relative w-[61px]" data-name="stepper-status">
        <Container2 />
      </div>
      <Container3 />
    </div>
...
function StepGroup() {
  return (
    <div className="relative w-full" data-name="step-group">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-[12px] pt-[16px] px-[16px] relative w-full">
          <div className="content-stretch flex flex-col h-[63px] items-center justify-center relative" data-name="stepper-status">
            <Container />
          </div>
          <MiddleStep />
          <div className="content-stretch flex flex-col h-[63px] items-center justify-center relative w-[47px]" data-name="stepper-status">
            <Container4 />
          </div>
        </div>
      </div>
...
function SubHeading() {
  return (
    <div className="relative w-full" data-name="sub-heading">
      <div className="flex flex-row items-center w-full">
        <div className="content-stretch flex items-center px-[16px] py-[12px] relative w-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Roboto_Serif:600',sans-serif] justify-center leading-[0] min-w-0 not-italic relative text-[#433059] text-[20px]">
            <p className="leading-[28px] font-[Roboto_Serif] font-bold">About the collection</p>
          </div>
        </div>
      </div>
    </div>
...
function CharCounterRow() {
  return (
    <div className="content-stretch flex items-center justify-end relative shrink-0 w-full" data-name="char-counter-row">
...
function DescriptionContainer() {
  return (
    <div className="content-stretch flex flex-col h-[90px] items-end justify-between relative shrink-0 w-full" data-name="description-container">
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#6b5f7a] text-[12px] tracking-[0.24px] w-full">
        <p className="leading-[18px]">Describe your collection, the concept, the story, behind it...</p>
      </div>
      <CharCounterRow />
    </div>
  );
...
function DescriptionField() {
  return (
    <div className="bg-white h-[114px] relative rounded-[8px] shrink-0 w-full" data-name="description-field">
...
function TextBox({ className = "" }: { className?: string } = {}) {
  return (
    <div className={`content-stretch flex flex-col items-stretch py-[12px] relative w-full ${className}`.trim()} data-name="text-box">
      <DescriptionField />
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[4px] items-center leading-[0] relative shrink-0 text-center whitespace-nowrap" data-name="upload-text-content">
      <div className="flex flex-col justify-center relative shrink-0 text-[#1a1128] text-[14px]">
        <p className="leading-[21px]">Upload Inspiration</p>
      </div>
...
function UploadTextContent1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[4px] items-center leading-[0] relative shrink-0 text-center whitespace-nowrap" data-name="upload-text-content">
      <div className="flex flex-col justify-center relative shrink-0 text-[#1a1128] text-[14px]">
        <p className="leading-[21px]">Upload color Story</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#6b5f7a] text-[12px] tracking-[0.24px]">
        <p className="leading-[18px]">JPEG, PNG</p>
      </div>
...
function UploadContent1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0" data-name="upload-content">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="palette">
        <div className="absolute inset-[9.37%_9.37%_12.5%_9.38%]" data-name="svg">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5003 18.7491">
            <path d={svgPaths.p3568380} fill="var(--fill-0, #7D3AEA)" id="svg" />
          </svg>
        </div>
      </div>
      <UploadTextContent1 />
...
function UploadTextContent2() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[4px] items-center leading-[0] relative shrink-0 text-center whitespace-nowrap" data-name="upload-text-content">
      <div className="flex flex-col justify-center relative shrink-0 text-[#1a1128] text-[14px]">
        <p className="leading-[21px]">Upload material story</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#6b5f7a] text-[12px] tracking-[0.24px]">
        <p className="leading-[18px]">JPEG, PNG</p>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0" data-name="upload-content">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="threads">
        <div className="absolute inset-[6.25%_11.5%_12.5%_18.75%]" data-name="svg">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.7398 19.5">
            <path d={svgPaths.pbe4bb70} fill="var(--fill-0, #7D3AEA)" id="svg" />
          </svg>
        </div>
      </div>
      <UploadTextContent2 />
...
function UploadTextContent3() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[4px] items-center leading-[0] relative shrink-0 text-center whitespace-nowrap" data-name="upload-text-content">
      <div className="flex flex-col justify-center relative shrink-0 text-[#1a1128] text-[14px]">
        <p className="leading-[21px]">Upload styling details</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#6b5f7a] text-[12px] tracking-[0.24px]">
        <p className="leading-[18px]">JPEG, PNG</p>
      </div>
...
function UploadContent3() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0" data-name="upload-content">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="handbag">
        <div className="absolute inset-[6.25%_6.25%_15.62%_6.24%]" data-name="svg">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.0038 18.75">
            <path d={svgPaths.p21581cc0} fill="var(--fill-0, #7D3AEA)" id="svg" />
          </svg>
        </div>
      </div>
      <UploadTextContent3 />
...
function AddImage() {
  return (
    <div className="content-stretch flex flex-col items-start py-[12px] relative w-full" data-name="add-image">
      <UploadDropzone4 />
    </div>
  );
}
...
function EditorForm() {
  return (
    <div className="relative w-full" data-name="editor-form">
      <div className="content-stretch flex flex-col items-stretch px-[16px] relative w-full">
        <TextBox />
        <div className="content-stretch flex flex-col items-stretch py-[12px] relative w-full" data-name="upload-documents">
          <UploadDropzone />
        </div>
        <div className="content-stretch flex flex-col items-stretch py-[12px] relative w-full" data-name="upload-documents">
          <UploadDropzone1 />
...
function EditorContent() {
  return (
    <div className="absolute content-stretch flex flex-col items-stretch left-0 right-0 top-[108px] w-full max-w-full min-w-0" data-name="editor-content">
      <StepGroup />
      <SubHeading />
      <EditorForm />
    </div>
...
function FooterActions() {
  return (
    <div className="absolute bg-white bottom-0 content-stretch drop-shadow-[0px_1px_2px_rgba(200,192,212,0.6)] flex flex-col items-stretch left-0 right-0 w-full max-w-full min-w-0" data-name="footer-actions">
      <div className="bg-[#fffeff] content-stretch flex gap-[16px] items-center justify-center px-[16px] py-[12px] relative w-full" data-name="portfolio-composer-toolbar">
        <MediaActions />
      ...
      <div className="bg-white content-stretch flex flex-col h-[46px] items-center justify-end pb-[8px] pt-[20px] px-[16px] relative w-full" data-name="bottom-safe-area">
        <div className="bg-[#1a1128] h-[4px] relative rounded-[200px] w-[130px]" data-name="home-indicator" />
      </div>
    </div>
  );
}
...
function NavActions() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative flex-1 min-w-0" data-name="nav-actions">
      <BackButton />
      <div className="[word-break:break-word] flex flex-col font-['Roboto_Serif:600',sans-serif] justify-center leading-[0] not-italic relative flex-1 min-w-0 text-[#1a1128] text-[24px]">
        <p className="leading-[31px] font-[Roboto_Serif] font-bold truncate">Add you Project</p>
      </div>
    </div>
  );
}
...
function TopBar() {
  return (
    <div className="absolute bg-[#fffeff] content-stretch flex flex-col items-stretch left-0 right-0 top-0 w-full max-w-full min-w-0" data-name="top-bar">
      <div className="bg-[#fffeff] content-stretch flex gap-[8px] h-[44px] items-center overflow-clip px-[16px] py-[8px] relative w-full" data-name="system-status-bar">
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] min-w-0 relative text-[#1a1128] text-[14px]" style={{ fontVariationSettings: '"wdth" 100' }}>
          <p className="leading-[20px]">9:41</p>
        </div>
        <Indicators />
      </div>
      <div className="bg-[#fffeff] relative w-full" data-name="header">
        <div className="flex flex-row items-center w-full">
...
export default function ProjectEditorScreen() {
  return (
    <div className="bg-[#fffeff] relative size-full" data-name="project-editor-screen">
      <EditorContent />
      <FooterActions />
      <TopBar />
    </div>
