...
function DateDivider() {
  return (
    <div
      className="bg-[#f7f4fa] content-stretch flex items-center justify-center px-[16px] py-[12px] relative rounded-[8px] shrink-0"
      data-name="date-divider"
    >
...
function MessageBubble() {
  return (
    <div
      className="bg-[#f7f4fa] content-stretch flex items-center justify-center max-w-[300px] px-[16px] py-[12px] relative rounded-br-[8px] rounded-tl-[8px] rounded-tr-[16px] shrink-0 w-[45px]"
...
function MessageBubble1() {
  return (
    <div
      className="bg-[#f7f4fa] content-stretch flex items-center justify-center max-w-[300px] px-[16px] py-[12px] relative rounded-bl-[8px] rounded-br-[8px] rounded-tl-[8px] shrink-0 w-[153px]"
      data-name="message-bubble"
    >
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1128] text-[14px]">
...
function MessageBubble2() {
  return (
    <div
      className="bg-[#f7f4fa] content-stretch flex items-center justify-center max-w-[300px] px-[16px] py-[12px] relative rounded-br-[8px] rounded-tl-[8px] rounded-tr-[8px] shrink-0"
      data-name="message-bubble"
    >
...
function ChatScreen() {
  return (
    <div
      className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[12px] items-center left-1/2 py-[28px] top-[116px] w-[390px]"
...
function InputPlaceholderWrap() {
  return (
    <div
      className="bg-[#fffeff] content-stretch flex flex-[1_0_0] items-center justify-center min-w-px py-[12px] relative"
      data-name="input-placeholder-wrap"
    >
...
function SendButton() {
  return (
    <div
      className="bg-[#7d3aea] content-stretch flex h-[47px] items-center justify-center p-[8px] relative rounded-[16px] shrink-0 w-[45px]"
...
function MessageInputRow() {
  return (
    <div
      className="bg-white content-stretch drop-shadow-[0px_4px_1.5px_rgba(200,192,212,0.6)] flex gap-[8px] h-[64px] items-center px-[16px] py-[8px] relative rounded-[16px] shrink-0 w-[358px]"
      data-name="message-input-row"
    >
      <div
        aria-hidden
        className="absolute border border-[#e2d9ef] border-solid inset-0 pointer-events-none rounded-[16px]"
      />
...
function MessageComposer() {
  return (
    <div
      className="absolute bg-white content-stretch flex flex-col items-start left-0 px-[16px] py-[12px] top-[710px] w-[390px]"
      data-name="message-composer"
    >
      <MessageInputRow />
    </div>
  );
...
function LockIcon() {
  return (
    <div
      className="bg-[#f5f0ff] content-stretch flex items-center p-[12px] relative rounded-[200px] shrink-0"
      data-name="lock-icon"
    >
      <div
        className="overflow-clip relative shrink-0 size-[24px]"
...
function ModalCopy() {
  return (
    <div
      className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start leading-[0] relative shrink-0 text-center w-full"
      data-name="modal-copy"
    >
...
function ModalIconStack() {
  return (
    <div
      className="content-stretch flex flex-col gap-[20px] items-center relative shrink-0 w-[175px]"
      data-name="modal-icon-stack"
    >
      <LockIcon />
      <ModalCopy />
    </div>
...
function ModalActions() {
  return (
    <div
      className="content-stretch flex gap-[12px] h-[48px] items-center justify-center relative shrink-0 w-full"
      data-name="modal-actions"
    >
      <div
        className="bg-white content-stretch flex gap-[8px] items-center justify-center max-h-[48px] min-h-[48px] px-[16px] py-[12px] relative rounded-[8px] shrink-0 w-[112px]"
      ...
      <div
        className="bg-gradient-to-r flex-[1_0_0] from-[#7d3aea] max-h-[48px] min-h-[48px] min-w-px relative rounded-[8px] to-[#5e28b5]"
        data-name="primary-button"
      >
...
function LockedChatModal() {
  return (
    <div
      className="-translate-x-1/2 -translate-y-1/2 absolute bg-white content-stretch drop-shadow-[0px_4px_2px_rgba(200,192,212,0.6)] flex flex-col gap-[28px] items-center left-1/2 px-[16px] py-[20px] rounded-[12px] top-[calc(50%+0.5px)] w-[358px]"
      data-name="locked-chat-modal"
    >
      <div
        aria-hidden
        className="absolute border border-[rgba(157,148,170,0.4)] border-solid inset-0 pointer-events-none rounded-[12px]"
      />
      <ModalIconStack />
      <ModalActions />
    </div>
...
export default function MessagingChatLocked() {
  return (
    <div
      ...
      data-name="messaging/chat-locked"
    >
      <ChatScreen />
      <MessageComposer />
      <div
        className="absolute bg-[#fffeff] content-stretch flex items-center justify-between left-0 px-[16px] py-[12px] top-[44px] w-[390px]"
        data-name="header"
      >
        <NavActions />
      </div>
      <div
        className="-translate-x-1/2 absolute backdrop-blur-[7.5px] bg-[rgba(26,26,26,0.2)] h-[754px] left-1/2 top-[44px] w-[390px]"
        data-name="blur-overlay"
      />
      <div
        className="absolute bg-[#fffeff] content-stretch flex gap-[8px] h-[44px] items-center left-0 overflow-clip px-[16px] py-[8px] top-0 w-[390px]"
      ...
      <div
        className="absolute bg-white content-stretch flex flex-col h-[46px] items-center justify-end left-0 pb-[8px] pt-[20px] px-[16px] top-[798px] w-[390px]"
