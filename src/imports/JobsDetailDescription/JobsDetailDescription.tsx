    ...
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-center min-w-px relative">
      ...
      <div className="bg-[#fffeff] content-stretch flex flex-col gap-[12px] h-[40px] items-center justify-end max-h-[40px] pt-[12px] px-[16px] relative shrink-0" data-name="tab/chip">
        ...
        <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1a1128] text-[16px] text-center text-ellipsis tracking-[0.16px] whitespace-nowrap">
          <p className="leading-[25px] overflow-hidden text-ellipsis">Description</p>
        </div>
      ...
      <div className="bg-[#fffeff] content-stretch flex h-[40px] items-center justify-center max-h-[40px] px-[16px] py-[12px] relative shrink-0" data-name="tab/chip">
        ...
        <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#6b5f7a] text-[16px] text-center text-ellipsis whitespace-nowrap">
          <p className="leading-[24px] overflow-hidden text-ellipsis">Reviews</p>
        </div>
      </div>
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="mb-[-16px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(264.845deg, rgb(247, 244, 250) 5.872%, rgb(239, 233, 252) 88.229%)" }} data-name="section-header">
          ...
          <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#433059] text-[0px] w-full">
            <ul className="list-disc">
              <li className="mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
                <span className="[word-break:break-word] font-['Manrope:Medium',sans-serif] font-medium leading-[21px] text-[14px] tracking-[0.14px]">Key Work:</span>
              ...
              <li className="mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
                <span className="[word-break:break-word] font-['Manrope:Medium',sans-serif] font-medium leading-[21px] text-[14px] tracking-[0.14px]">Ideal Candidate:</span>
                <span className="leading-[24px] text-[16px]">{` `}</span>
                <span className="[word-break:break-word] font-['Manrope:Regular',sans-serif] font-normal leading-[21px] text-[#6b5f7a] text-[14px]">Strong appreciation for Indian craftsmanship, detail-oriented, curious, collaborative, and eager to learn.</span>
              </li>
              <li className="ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
                <span className="[word-break:break-word] font-['Manrope:Medium',sans-serif] font-medium leading-[21px] text-[14px] tracking-[0.14px]">Skills Required:</span>
                ...
                <span className="leading-[24px] text-[#6b5f7a] text-[16px]">.</span>
              </li>
            </ul>
          </div>
        </div>
...
function AiJobSummary() {
  return (
    <div className="content-stretch drop-shadow-[0px_1px_2px_rgba(132,111,132,0.12)] flex flex-col items-start max-w-[800px] relative shrink-0 w-full" data-name="ai-job-summary">
      <SectionHeader />
      <SectionContent />
    </div>
  );
...
function Gride() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[181px] items-start relative shrink-0" data-name="gride">
      <div className="h-[99px] relative rounded-[4px] shrink-0 w-[124px]" data-name="image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[4px] size-full" src={imgImage1} />
      </div>
      <div className="h-[74px] relative rounded-[4px] shrink-0 w-[124px]" data-name="image">
...
function JobDescriptionImages() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[358px]" data-name="job-description-images">
      <Gride />
      <div className="h-[181px] relative rounded-[4px] shrink-0 w-[226px]" data-name="image">
...
function ReadMore() {
  return (
    <div className="content-stretch flex gap-[12px] h-[24px] items-center relative shrink-0" data-name="read-more">
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="chevron-icon">
        <div className="absolute inset-[34.37%_15.62%_28.12%_15.62%]" data-name="Svg">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.7507 7.50084">
            <path d={svgPaths.p1276f900} fill="var(--fill-0, #6B5F7A)" id="Svg" />
          </svg>
        </div>
      </div>
    </div>
...
function JobDescriptionText() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="job-description-text">
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full overflow-hidden relative shrink-0 text-[#433059] text-[16px] text-ellipsis w-[min-content] whitespace-pre-wrap">
        <p className="leading-[24px] mb-0">Are you a designer eager to experience what it feels like when your work becomes part of iconic couture worn across generations? If you have a deep appreciation for Indian craftsmanship, textiles, and detail-driven design, this role is for you.</p>
        <p className="leading-[24px] mb-0">​</p>
        <p className="leading-[24px] mb-0">Sabyasachi is looking for a Junior Fashion Designer to join its New Delhi studio. This is a full-time role where you will learn by doing—working closely with senior designers, artisans, and production teams. You’ll absorb the brand’s design philosophy, heritage-led thinking, and uncompromising quality standards through hands-on involvement across the entire design lifecycle.</p>
        <p className="leading-[24px] mb-0">​</p>
        <p className="leading-[24px] mb-0">Who Is an Ideal Match for Sabyasachi?</p>
        <p className="leading-[24px] mb-0">​</p>
        <p className="leading-[24px] mb-0">We are looking for designers who resonate with the brand’s ethos and approach to craft.</p>
...
function JobDescription() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start max-w-[800px] min-w-[320px] relative shrink-0 w-full" data-name="job-description">
    ...
    <div className="overflow-clip relative rounded-[8px] shrink-0 size-[54px]" data-name="company-logo">
      <div className="absolute inset-0 pointer-events-none rounded-[8px]" data-name="image">
        <div className="absolute inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute left-[-23.1%] max-w-none size-[146.3%] top-[-21.73%]" src={imgImage5} />
        </div>
        <div aria-hidden="true" className="absolute border border-[#e2d9ef] border-solid inset-0 rounded-[8px]" />
      </div>
    </div>
...
function CompanyLogo3() {
  return (
    <div className="overflow-clip relative rounded-[8px] shrink-0 size-[54px]" data-name="company-logo">
      <div className="absolute inset-0 pointer-events-none rounded-[8px]" data-name="image">
        <img alt="" className="absolute inset-0 max-w-none object-contain rounded-[8px] size-full" src={imgImage6} />
        <div aria-hidden="true" className="absolute border border-[#e2d9ef] border-solid inset-0 rounded-[8px]" />
      </div>
    </div>
  );
...
function JobDetailsPage() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#fffeff] content-stretch flex flex-col items-start left-1/2 max-w-[800px] min-w-[360px] top-[108px] w-[390px]" data-name="job-details-page">
      <JobDetails />
      <TabList />
      <DetailedSections />
      <SimilarJobs />
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="footer">
      <div className="content-stretch flex gap-[16px] items-start pb-[24px] pt-[12px] px-[16px] relative size-full">
        ...
        <div className="bg-gradient-to-r content-stretch flex from-[#7d3aea] gap-[8px] h-[48px] items-center justify-center max-h-[48px] min-h-[48px] px-[16px] py-[12px] relative rounded-[8px] shrink-0 to-[#5e28b5] w-[202px]" data-name="primary-button">
...
export default function JobsDetailDescription() {
  return (
    <div className="bg-[#fffeff] relative size-full" data-name="jobs/detail-description">
      <JobDetailsPage />
      <TopBar />
      <FooterSection />
    </div>
