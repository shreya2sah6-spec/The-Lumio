...
function MessageBubble() {
  return (
    <div
      className="bg-[#f7f4fa] content-stretch flex items-center justify-center max-w-[300px] px-[16px] py-[12px] relative rounded-br-[8px] rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[45px]"
...
function MessageBubble1() {
  return (
    <div
      className="bg-[#9f99e6] content-stretch flex items-center justify-center max-w-[300px] px-[16px] py-[12px] relative rounded-br-[8px] rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[153px]"
      data-name="message-bubble"
    >
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#1a1128] text-[14px]">
...
function ChatScreen() {
  return (
    <div
      className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[12px] items-center left-1/2 max-w-[800px] min-w-[360px] py-[28px] top-[116px] w-[390px]"
...
function MessageInputFooter() {
  return (
    <div
      className="-translate-x-1/2 absolute bg-white bottom-0 content-stretch flex flex-col items-start left-1/2 w-[390px]"
      data-name="message-input-footer"
    >
      <MessageInputField />
      <BottomSafeArea />
    </div>
...
function MenuButton() {
  return (
    <div
      className="content-stretch flex items-center justify-center p-[4px] relative shrink-0 size-[40px]"
      ...
      >
        <div className="absolute inset-[18.75%_45.31%]" data-name="svg">
          <svg
            ...
            fill="none"
            preserveAspectRatio="none"
            viewBox="0 0 2.625 17.5"
          >
            <path
              d={svgPaths.p37c5a400}
