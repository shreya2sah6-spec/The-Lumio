import svgPaths from "./svg-v6bqq5mtqr";
...
function Profile() {
  return (
    <div className="content-stretch flex items-center p-[2px] relative rounded-[24px] shrink-0 size-[20px]" data-name="Profile">
      <div aria-hidden className="absolute border border-[#1a1128] border-solid inset-0 pointer-events-none rounded-[24px]" />
...
export default function NarBar() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_-1px_2px_rgba(200,192,212,0.6)] flex gap-[12px] items-center justify-center px-[16px] py-[8px] relative size-full" data-name="nar-bar">
      <NavItem />
      <NavItem1 />
      <NavItem2 />
      <NavItem3 />
