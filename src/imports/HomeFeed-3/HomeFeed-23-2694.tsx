...
function EngagementActionBadge() {
  return (
    <div
      className="bg-[rgba(26,26,26,0.6)] col-1 content-stretch flex items-center justify-center ml-[12px] mt-[9px] p-[4px] relative rounded-[200px] row-1"
      data-name="engagement-action-badge"
    >
      <div
...
function EngagementBadge() {
  return (
    ...
    >
      ...
      >
        <div
          className="-translate-y-1/2 absolute aspect-[20/20] left-0 right-0 rounded-[200px] top-1/2"
          data-name="image"
        >
          <img
            alt=""
...
function EngagementOverlay() {
  return (
    <div
      className="bg-white content-stretch flex gap-[8px] h-[46px] items-center leading-[0] min-h-[46px] p-[8px] relative rounded-[8px] shrink-0"
      data-name="engagement-overlay"
    >
      <EngagementBadge />
...
function EngagementContainer() {
  return (
    <div
      className="absolute bottom-0 content-stretch flex flex-col items-center justify-center left-0 p-[16px]"
      data-name="engagement-container"
    >
      <EngagementOverlay />
    </div>
  );
...
function PostContent() {
  return (
    <div
      className="aspect-[390/348] relative shrink-0 w-full"
      data-name="post-content"
    >
      <div
        className="-translate-y-1/2 absolute aspect-[390/348] left-0 right-0 top-1/2"
        data-name="post-image-01"
      >
        <div
          aria-hidden="true"
        ...
        >
          <div className="absolute inset-0 overflow-hidden">
            <img
              alt=""
              className="absolute h-[112.28%] left-[-0.08%] max-w-none top-[-3.7%] w-full"
              src={imgPostImage01}
            />
          </div>
...
function AuthorDetails() {
  return (
    <div
      className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start leading-[0] min-w-px relative"
      data-name="author-details"
    >
      <CreatorMeta />
...
function EngagementContainer1() {
  return (
    <div
      className="absolute bottom-0 content-stretch flex flex-col h-[78px] items-center justify-center left-0 p-[16px] w-[226px]"
      data-name="engagement-container"
    />
  );
}
...
function AvatarPrimary() {
  return (
    <div
      className="absolute left-0 overflow-clip size-[32px] top-0"
      data-name="avatar-primary"
    >
      <div
        className="absolute aspect-[800/800] left-0 pointer-events-none right-0 rounded-bl-[200px] rounded-tl-[200px] rounded-tr-[200px] top-0"
        data-name="avatar-image"
      >
        <div className="absolute inset-0 overflow-hidden rounded-bl-[200px] rounded-tl-[200px] rounded-tr-[200px]">
          <img
            alt=""
            className="absolute h-[119.57%] left-[-22.1%] max-w-none top-[-2.9%] w-[179.36%]"
            src={imgAvatarImage}
          />
        </div>
        <div
          aria-hidden="true"
          className="absolute border border-[#e2d9ef] border-solid inset-0 rounded-bl-[200px] rounded-tl-[200px] rounded-tr-[200px]"
        />
      </div>
    </div>
  );
...
function AvatarSecondary() {
  return (
    <div
      className="absolute left-[16px] overflow-clip size-[32px] top-[16px]"
      data-name="avatar-secondary"
    >
      <div
        className="absolute aspect-[800/800] bottom-0 left-0 pointer-events-none right-0 rounded-br-[200px] rounded-tl-[200px] rounded-tr-[200px]"
        data-name="avatar-image"
      >
        <div className="absolute inset-0 overflow-hidden rounded-br-[200px] rounded-tl-[200px] rounded-tr-[200px]">
          <img
            alt=""
            className="absolute h-[368%] left-[-47.39%] max-w-none top-[-140.08%] w-[245.33%]"
            src={imgAvatarImage2}
          />
        </div>
        <div
          aria-hidden="true"
          className="absolute border border-[#e2d9ef] border-solid inset-0 rounded-br-[200px] rounded-tl-[200px] rounded-tr-[200px] shadow-[-1px_0px_2px_0px_rgba(26,26,26,0.15)]"
        />
      </div>
    </div>
  );
    ...
    >
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center overflow-hidden relative shrink-0 text-[#2d2040] text-[0px] text-ellipsis tracking-[0.16px] w-full">
        <p className="text-[16px]">
          <span className="font-['Manrope:Medium',sans-serif] font-medium leading-[25px]">
            Neha Jain
          </span>
          <span className="font-['Manrope:Regular',sans-serif] font-normal leading-[18px] text-[#433059] text-[12px] tracking-[0.24px]">{` `}</span>
          <span className="font-['Manrope:Regular',sans-serif] font-normal leading-[18px] text-[#433059] text-[12px] tracking-[0.24px]">
            co-create with
          </span>
    ...
    >
      ...
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1a1128] text-[14px] text-ellipsis w-full">
        <p className="leading-[21px]">
          A Celebration of Resilience, Beauty, and Feminine Power.
        </p>
      </div>
    </div>
  );
...
function Heding() {
  return (
    ...
    >
      ...
      <div
        className="flex-[1_0_0] h-0 min-w-px relative"
...
function Caption() {
  return (
    <div
      className="-translate-x-1/2 absolute bottom-0 content-stretch flex items-center justify-center left-1/2 px-[12px] py-[16px] w-[240px]"
      data-name="caption"
    >
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[16px] text-center text-ellipsis text-white w-[210px]">
        <p className="leading-[24px]">
          Floral fashion makes its bold comeback.
        </p>
      </div>
    </div>
  );
...
function Views() {
  return (
    <div
      className="absolute bg-[rgba(26,26,26,0.6)] content-stretch flex gap-[8px] items-center left-[148px] px-[8px] py-[4px] rounded-[4px] top-[16px]"
      data-name="views"
    >
      <Eye />
...
function Caption1() {
  return (
    ...
    >
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[16px] text-center text-ellipsis text-white w-[210px]">
        <p className="leading-[24px]">
          Maximalist glamour is everywhere this season.
        </p>
      </div>
    </div>
  );
...
function MomentumCarousel() {
  return (
    <div
      className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[358px]"
      data-name="momentum-carousel"
    >
      <div
        className="h-[300px] overflow-clip relative rounded-[8px] shrink-0 w-[240px]"
        data-name="creative-momentum-card"
      >
        <div
          className="-translate-y-1/2 absolute aspect-[240/300] left-0 right-0 top-1/2"
      ...
      >
        <div
          className="-translate-y-1/2 absolute aspect-[240/300] left-0 right-0 top-1/2"
          data-name="creative-card-03"
        >
          <img
            alt=""
            className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
            src={imgCreativeCard03}
          />
        </div>
        <Caption2 />
        <Views2 />
      ...
      >
        <div
          className="-translate-y-1/2 absolute aspect-[240/300] left-0 right-0 top-1/2"
          data-name="creative-card-04"
        >
          <img
            alt=""
            className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
            src={imgCreativeCard04}
          />
        </div>
        <Caption3 />
        <Views3 />
...
function CreativeMomentumSection() {
  return (
    <div
      ...
      data-name="creative-momentum-section"
    >
...
function CreatorMeta2() {
  return (
    <div
      className="[word-break:break-word] content-stretch flex flex-col items-start leading-[0] relative shrink-0 w-full"
      data-name="creator-meta"
    >
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center overflow-hidden relative shrink-0 text-[#1a1128] text-[16px] text-ellipsis tracking-[0.16px] w-full">
      ...
      <div className="relative shrink-0 size-[48px]" data-name="avatar">
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[200px]">
            <img
              alt=""
              className="absolute h-[147.19%] left-0 max-w-none top-[-1.41%] w-full"
              src={imgAvatarImage3}
            />
          </div>
        </div>
...
function PostHeader2() {
  return (
    ...
    >
      ...
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1a1128] text-[14px] text-ellipsis w-full">
        <p className="leading-[21px]">
          A Rajasthani jewelry showcases vibrant colors, intricate
          craftsmanship, and royal heritage.
        </p>
      </div>
    </div>
  );
...
function PromoCard() {
  return (
    <div
      className="h-[291px] overflow-clip relative rounded-[4px] shrink-0 w-[292px]"
      data-name="promo-card-1"
    >
      <div
        className="-translate-y-1/2 absolute h-[291px] left-0 right-0 top-1/2"
...
function PromoImagesCarousel() {
  return (
    <div
      className="content-stretch flex gap-[12px] items-center px-[16px] relative shrink-0 w-[390px]"
      data-name="promo-images-carousel"
    >
      <PromoCard />
      <PromoCard1 />
      <PromoCard2 />
      <PromoCard3 />
      <div
        className="bg-white h-[291px] relative shrink-0 w-[8px]"
        data-name="carousel-spacer"
      />
    </div>
  );
}
...
function BrandDeatils() {
  return (
    <div
      className="[word-break:break-word] content-stretch flex flex-col h-full items-start leading-[0] relative shrink-0 w-[254px]"
      data-name="brand-deatils"
    >
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center overflow-hidden relative shrink-0 text-[#1a1128] text-[16px] text-ellipsis tracking-[0.16px] w-full">
...
function BrandJobPostingDetails() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full"
      data-name="brand-job-posting-details"
    >
      <BrandHeaderRow />
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1a1128] text-[14px] text-ellipsis w-full">
        <p className="leading-[21px]">
          An exciting chance to join one of India’s fashion houses apply now and
...
function PostActions() {
  return (
    ...
    >
      <div
        className="bg-gradient-to-r from-[#7d3aea] h-[48px] max-h-[48px] min-h-[48px] relative rounded-[8px] shrink-0 to-[#5e28b5] w-full"
...
function PostDetails3() {
  return (
    <div
      className="bg-[#fffeff] content-stretch flex flex-col gap-[12px] items-start pb-[24px] pt-[12px] px-[16px] relative shrink-0 w-[390px]"
      data-name="post-details"
    >
...
function BrandJobCard() {
  return (
    <div
      className="bg-[#fffeff] content-stretch flex flex-col items-center relative shrink-0"
      data-name="brand-job-card"
    >
      <PromoImagesCarousel />
      <PostDetails3 />
    </div>
...
function BrandJobPost() {
  return (
    <div
      className="bg-white content-stretch flex items-center overflow-clip pt-[8px] relative shrink-0 w-full"
      data-name="brand-job-post"
    >
      <BrandJobCard />
    </div>
  );
      ...
      <div className="relative shrink-0 size-[48px]" data-name="avatar">
        ...
        >
          <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[200px]">
            <img
              alt=""
              className="absolute h-[150.1%] left-0 max-w-none top-[-3.26%] w-full"
              src={imgAvatarImage4}
            />
          </div>
        </div>
...
function PostHeader3() {
  return (
    ...
    >
      ...
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1a1128] text-[14px] text-ellipsis w-full">
        <p className="leading-[21px]">
          Denim dreams stitched with confidence and runway elegance.
        </p>
      </div>
    </div>
  );
...
function EngagementActionBadge1() {
  return (
    ...
    >
      <div
        className="overflow-clip relative shrink-0 size-[12px]"
        data-name="hands-clapping"
      >
        <div
          className="-translate-y-1/2 absolute aspect-[20.99896240234375/24.00555419921875] left-[16.67%] right-[12.5%] top-1/2"
          data-name="Vector"
        >
          <svg
            className="absolute block inset-0 size-full"
            fill="none"
            preserveAspectRatio="none"
            viewBox="0 0 8.5 9.71701"
          >
            <path
              d={svgPaths.p358bfa00}
...
function EngagementOverlay1() {
  return (
    ...
    >
      ...
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center overflow-hidden relative shrink-0 text-[#2d2040] text-[12px] text-ellipsis tracking-[0.24px] w-[138px] whitespace-nowrap">
        <p className="leading-[18px] overflow-hidden text-ellipsis">
          Sr. Designer from Papa Dont’ Preach
        </p>
      </div>
    </div>
  );
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img
            alt=""
            className="absolute h-[112.07%] left-0 max-w-none top-[-4.23%] w-full"
            src={imgPostImage4}
          />
        </div>
      </div>
...
function PostHeader4() {
  return (
    ...
    >
      ...
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#1a1128] text-[14px] text-ellipsis w-full">
        <p className="leading-[21px]">
          A luxe crystal-embellished 3D handbag blending glamour with modern
          elegance.
        </p>
      </div>
    </div>
...
function FeedContent() {
  return (
    <div
      className="content-stretch flex flex-col gap-[4px] items-start max-w-[800px] min-w-[360px] relative shrink-0 w-full"
      data-name="feed-content"
    >
      <div
...
function NavItem() {
  return (
    ...
    >
      ...
      >
        <div
          className="absolute inset-[9.38%_12.5%_12.5%_12.5%]"
          data-name="Svg"
        >
          <svg
            className="absolute block inset-0 size-full"
            fill="none"
            preserveAspectRatio="none"
            viewBox="0 0 18 18.7493"
          >
            <path
              d={svgPaths.p34ca7200}
...
function MessagingAction() {
  return (
    <div
      className="content-stretch flex items-center p-[8px] relative shrink-0"
      data-name="messaging-action"
    >
      <div
        className="overflow-clip relative shrink-0 size-[24px]"
        data-name="chat-centered-dots"
      >
        <div
          className="absolute inset-[15.63%_9.38%_9.38%_9.38%]"
          data-name="Svg"
        >
          <svg
            className="absolute block inset-0 size-full"
...
function TopBar() {
  return (
    <div
      className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col items-start left-1/2 max-w-[724px] top-0 w-[390px]"
      data-name="top-bar"
    >
      <StatusBar />
