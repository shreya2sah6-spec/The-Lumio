import svgPaths from "./svg-fl64q9u2f3";
import imgAddYourProjectImage01 from "./846815df5564164f2f6919ab3ef355ec01c28320.png";
import imgAddYourProjectImage02 from "./5e0b1e20482fe6dcd68080b2012e3df25f2c4384.png";
import imgAddYourProjectImage03 from "./e87648c80aef9266af694e497ad0e2ef854d8d80.png";
import imgAddYourProjectImage04 from "./f29fd164e841cb5399d8efa56b4e03f335a09cca.png";
...
function StepGroup() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="step-group">
      <Container1 />
      <div className="content-stretch flex flex-col h-[63px] items-center justify-center relative shrink-0 w-[61px]" data-name="stepper-status">
        <Container2 />
      </div>
      <Container3 />
    </div>
...
function ProjectTitle() {
  return (
    <div className="relative shrink-0 w-full" data-name="project-title">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[12px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[#2d2040] text-[16px]">
...
function AddImageDropzone() {
  return (
    <div className="content-stretch flex flex-col items-start py-[12px] relative shrink-0 w-[358px]" data-name="add-image-dropzone">
      <UploadDropzone />
    </div>
  );
}
...
function PreviewContent() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="preview-content">
      <ProjectTitle />
      <div className="h-[347px] relative shrink-0 w-full" data-name="add-your-project-image-01">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgAddYourProjectImage01} />
      </div>
      <div className="h-[347px] relative shrink-0 w-full" data-name="add-your-project-image-02">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgAddYourProjectImage02} />
      </div>
      <div className="h-[347px] relative shrink-0 w-full" data-name="add-your-project-image-03">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgAddYourProjectImage03} />
      </div>
      <div className="h-[347px] relative shrink-0 w-full" data-name="add-your-project-image-04">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgAddYourProjectImage04} />
      </div>
      <AddImageDropzone />
    </div>
  );
...
function EditorContent() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-0 max-w-[800px] min-w-[360px] top-[108px] w-[390px]" data-name="editor-content">
      <Steps />
      <SubHeading />
      <PreviewContent />
    </div>
...
function FooterActions() {
  return (
    <div className="-translate-x-1/2 absolute bg-white bottom-0 content-stretch drop-shadow-[0px_1px_2px_rgba(200,192,212,0.6)] flex flex-col items-center left-1/2 max-w-[800px] min-w-[360px] w-[390px]" data-name="footer-actions">
...
export default function ProjectEditorPreviewScreen() {
  return (
    <div className="bg-[#fffeff] relative size-full" data-name="project-editor-preview-screen">
      <EditorContent />
      <FooterActions />
      <TopBar />
    </div>
