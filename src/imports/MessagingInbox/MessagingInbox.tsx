import svgPaths from "./svg-xl3817y08q";
import imgImage from "./915a716cc5b6ad4efd2b16355a601dbc5e28776c.png";
import imgImage1 from "./424a03d1946d4f9a9f1bbebe51d8413d38f90e7e.png";
import imgImage2 from "./0e24066874f0be293f0c1d91df85f101e8dea5b1.png";
import imgImage3 from "./4d8c1cdcbd72c0d90f93dc409460ca3438894fda.png";
import imgImage4 from "./e34caf60e58ca4e206248426862d5b85ef3277e7.png";
import imgImage5 from "./080e35c814459028d879ec28439f5343daed2224.png";
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-center justify-center pt-[16px] px-[16px] relative size-full">
          <MessageItem />
          <MessageItem1 />
          <MessageItem2 />
          <MessageItem3 />
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[4px] relative size-full">
          ...
          <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-[1_0_0] flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px overflow-hidden relative text-[#6b5f7a] text-[14px] text-ellipsis whitespace-nowrap">
            <p className="leading-[21px] overflow-hidden text-ellipsis">{`Search messages `}</p>
          </div>
        </div>
      </div>
    </div>
