...
function TabList() {
  return (
    <div
      className="content-stretch flex items-center pb-[8px] pt-[16px] px-[16px] relative shrink-0 w-[390px]"
      data-name="tab-list"
    >
      <Frame />
    </div>
...
function ProfileImage() {
  return (
    ...
    >
      <div
        className="pointer-events-none relative rounded-[200px] shrink-0 size-[44px]"
        data-name="image"
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[327.8%] left-[-52.67%] max-w-none top-[-49.22%] w-[218.31%]"
            src={imgImage}
          />
        </div>
        <div
...
function TopMentorTag() {
  return (
    <div
      className="bg-gradient-to-l content-stretch flex from-[rgba(247,181,0,0.4)] items-center justify-center p-[8px] relative rounded-[2px] shrink-0 to-[rgba(254,250,225,0.4)]"
      data-name="top-mentor-tag"
    >
...
function MentorInfo() {
  return (
    <div
      className="[word-break:break-word] content-stretch flex flex-col gap-[2px] items-start leading-[0] relative shrink-0 w-full"
      data-name="mentor-info"
    >
...
function DiscountedPriceGroup() {
  return (
    <div
      ...
      data-name="discounted-price-group"
    >
...
function Pricing() {
  return (
    <div
      className="[word-break:break-word] content-stretch flex flex-[1_0_0] gap-[2px] items-center leading-[0] min-w-px relative whitespace-nowrap"
      data-name="pricing"
    >
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#6b5f7a] text-[0px] tracking-[0.24px]">
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-from-font decoration-solid leading-[18px] line-through text-[12px]">
          ₹ 600
        </p>
      </div>
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[148.76%] left-[-0.4%] max-w-none top-[-23.81%] w-[99.07%]"
            src={imgImage1}
          />
        </div>
        <div
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[272.88%] left-[-51.35%] max-w-none top-[-69.35%] w-[181.73%]"
            src={imgImage2}
          />
        </div>
        <div
...
function MentorsList() {
  return (
    <div
      className="gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[__fit-content(100%)_215px] max-w-[768px] min-w-[320px] relative shrink-0 w-full"
      data-name="mentors-list"
    >
      <div
        className="bg-white justify-self-stretch max-w-[340px] min-w-[158px] relative rounded-[8px] self-start shrink-0"
        data-name="mentor-card"
      >
        <div
          aria-hidden="true"
          className="absolute border border-[#e2d9ef] border-solid inset-0 pointer-events-none rounded-[8px]"
        />
        <div className="content-stretch flex flex-col gap-[8px] items-start max-w-[inherit] min-w-[inherit] px-[16px] py-[12px] relative size-full">
          <MentorHeader />
          <div
            className="content-stretch flex gap-[4px] h-[18px] items-center relative shrink-0 w-full"
...
function TopRatedGeneralMentors() {
  return (
    <div
      ...
      data-name="top-rated-general-mentors"
    >
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[336.09%] left-[-44.81%] max-w-none top-[-47.87%] w-[189.05%]"
            src={imgImage4}
          />
        </div>
        <div
...
function MentorInfo4() {
  return (
    ...
    >
      ...
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center overflow-hidden relative shrink-0 text-[#433059] text-[12px] text-ellipsis tracking-[0.24px] w-full whitespace-nowrap">
        <p className="leading-[18px] overflow-hidden text-ellipsis">
          Lead Fashion Designer @ Anita Dongre
        </p>
      </div>
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center overflow-hidden relative shrink-0 text-[#6b5f7a] text-[12px] text-ellipsis tracking-[0.24px] w-full whitespace-nowrap">
        <p className="leading-[18px] overflow-hidden text-ellipsis">
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[327.8%] left-[-96.44%] max-w-none top-[-43.27%] w-[218.31%]"
            src={imgImage5}
          />
        </div>
        <div
...
function MentorInfo5() {
  return (
    ...
    >
      ...
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center overflow-hidden relative shrink-0 text-[#433059] text-[12px] text-ellipsis tracking-[0.24px] w-full whitespace-nowrap">
        <p className="leading-[18px] overflow-hidden text-ellipsis">
          Mid-Level Designer @ Biba
        </p>
      </div>
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center overflow-hidden relative shrink-0 text-[#6b5f7a] text-[12px] text-ellipsis tracking-[0.24px] w-full whitespace-nowrap">
        <p className="leading-[18px] overflow-hidden text-ellipsis">
          5 yrs exp • EX - Forever 21
        </p>
      </div>
    </div>
  );
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[209.19%] left-[-28.69%] max-w-none top-[0.8%] w-[167.26%]"
            src={imgImage6}
          />
        </div>
        <div
...
function MentorInfo6() {
  return (
    ...
    >
      ...
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center overflow-hidden relative shrink-0 text-[#433059] text-[12px] text-ellipsis tracking-[0.24px] w-full whitespace-nowrap">
        <p className="leading-[18px] overflow-hidden text-ellipsis">
          Sr. Fashion Designer @ Manyavar
        </p>
      </div>
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center overflow-hidden relative shrink-0 text-[#6b5f7a] text-[12px] text-ellipsis tracking-[0.24px] w-full whitespace-nowrap">
        <p className="leading-[18px] overflow-hidden text-ellipsis">
          9 yrs exp • EX - Tommy Hilfiger
        </p>
      </div>
    </div>
  );
...
function DiscountedPriceGroup6() {
  return (
    <div
      className="[word-break:break-word] content-stretch flex items-center leading-[0] relative shrink-0 whitespace-nowrap"
      data-name="discounted-price-group"
    >
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#1a1128] text-[14px] tracking-[0.14px]">
        <p className="leading-[21px]">₹250</p>
...
function Pricing6() {
  return (
    <div
      className="content-stretch flex flex-[1_0_0] gap-[2px] items-center min-w-px relative"
      data-name="pricing"
    >
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden rounded-[200px]">
          <img
            alt=""
            className="absolute h-[235.55%] left-[-35.19%] max-w-none top-[-0.48%] w-[168.18%]"
            src={imgImage7}
          />
        </div>
        <div
...
function MentorsList1() {
  return (
    <div
      className="gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[__fit-content(100%)_215px] relative shrink-0 w-full"
      data-name="mentors-list"
    >
      <div
        className="bg-white justify-self-stretch max-w-[340px] min-w-[158px] relative rounded-[8px] self-start shrink-0"
...
function MentorsContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[16px] items-start max-w-[768px] min-w-[320px] relative shrink-0 w-full"
      data-name="mentors-container"
    >
      <MentorsList1 />
      <div
...
function PickedForYouMentors() {
  return (
    <div
      className="max-w-[768px] min-w-[320px] relative shrink-0 w-full"
      data-name="picked-for-you-mentors"
    >
...
function MentorsScreenContent() {
  return (
    <div
      className="absolute content-stretch flex flex-col items-start left-0 max-w-[768px] min-w-[360px] top-[108px] w-[390px]"
      data-name="mentors-screen-content"
    >
      <TabList />
      <MentorsContent />
    </div>
