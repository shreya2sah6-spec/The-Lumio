...
import { House, Briefcase, Plus, Users, User } from "@phosphor-icons/react";
    ...
    <div className="min-h-screen bg-[#fffeff] flex items-start justify-center">
      <div className="w-full max-w-[800px] min-w-[360px] bg-[#fffeff] flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col items-start justify-start">
          ...
          <div className="bg-[#f5f0ff] w-full flex flex-col gap-[16px] items-start justify-center p-[16px]">
            {/* Content stack with heading and progress */}
            <div className="h-[61px] relative w-full">
              ...
              {/* Progress row */}
              <div className="absolute h-[25px] left-0 top-[36px] w-full">
                {/* Progress segment */}
                <div className="absolute h-[4px] left-0 overflow-clip rounded-[200px] top-[12px] max-w-[311px] w-[calc(100%-47px)]">
                  {/* Progress track (background) */}
                  <div className="absolute bg-white border-[#e2d9ef] border-[0.2px] border-solid h-[4px] left-0 right-0 rounded-[200px] top-0" />
                  {/* Progress fill */}
                  <div className="absolute bg-[#7d3aea] h-[4px] left-0 right-[60.13%] rounded-[200px] top-0" />
                </div>
                {/* Percentage */}
                <div className="absolute right-0 top-0">
                  <p className="font-['Manrope',sans-serif] font-medium text-[#433059] text-[16px] leading-[25px] tracking-[0.16px]">
                    40%
                  </p>
                </div>
              </div>
