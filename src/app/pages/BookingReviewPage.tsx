  ...
  return (
    <div className="min-h-screen bg-[#fffeff] flex items-start justify-center">
      <div className="w-full max-w-[800px] min-w-[360px] bg-[#fffeff] flex flex-col min-h-screen">
        ...
        <div className="w-full bg-[#fffeff] flex h-[44px] items-center justify-between px-4 py-2 shrink-0">
          ...
          <div className="flex gap-[2px] items-center shrink-0">
            ...
            <div className="h-[15.385px] relative w-[24.038px]">
              ...
              >
                <path
                  d="M3.02599 2.71124H19.0514C20.2019 2.71129 21.1344 3.64466 21.1344 4.79522V10.5638C21.1344 11.7143 20.2019 12.6477 19.0514 12.6478H3.02599C1.8754 12.6478 0.942008 11.7144 0.942008 10.5638V4.79522C0.942008 3.64463 1.8754 2.71124 3.02599 2.71124Z"
                  opacity="0.35"
                  stroke="#9D94AA"
                  strokeOpacity="0.4"
                ...
                />
                <path
                  d="M22.5769 5.75643V9.60258C23.3507 9.27684 23.8539 8.51906 23.8539 7.67951C23.8539 6.83996 23.3507 6.08218 22.5769 5.75643"
                  fill="#1A1128"
                  opacity="0.4"
                />
                <path
                  d="M2.38462 5.4359C2.38462 4.72784 2.95861 4.15385 3.66667 4.15385H18.4103C19.1183 4.15385 19.6923 4.72784 19.6923 5.4359V9.92308C19.6923 10.6311 19.1183 11.2051 18.4103 11.2051H3.66667C2.95861 11.2051 2.38462 10.6311 2.38462 9.92308V5.4359Z"
                  fill="#1A1128"
                />
              </svg>
            </div>
        ...
        <PageHeader title="Review the Booking" onBack={onBack} sticky shadow />
          ...
          <div className="px-4">
            ...
            <div className="flex flex-col gap-[16px] py-[20px]">
              ...
              <div className="relative bg-white rounded-[8px] h-[140px]">
                <div
                  aria-hidden
                  className="absolute border border-[rgba(157,148,170,0.4)] inset-0 pointer-events-none rounded-[8px]"
                />
                <textarea
                  value={callAbout}
                  onChange={(e) => {
                    if (e.target.value.length <= MAX_CHARS)
                      setCallAbout(e.target.value);
                  }}
              ...
              <div className="relative rounded-[8px] w-full">
                <div className="flex flex-col overflow-clip rounded-[8px]">
                  ...
                  <div className="bg-[#f7f4fa] relative px-[16px] py-[12px]">
                    <div
                      aria-hidden
                      className="absolute border-b border-[rgba(157,148,170,0.4)] inset-0 pointer-events-none"
                    />
                ...
                <div
                  aria-hidden
                  className="absolute border border-[rgba(157,148,170,0.4)] inset-[-0.5px] pointer-events-none rounded-[8.5px]"
                />
              </div>
