...
function StatusBar() {
  return (
    <div className="w-full bg-[#fffeff] flex h-11 items-center justify-between px-4 py-2 shrink-0">
      ...
      <div className="flex gap-[2px] items-center shrink-0">
        <div className="h-[15.385px] relative w-[19.231px]">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.2308 15.3846">
            <path d={svgStatus.p34f07b00} fill="#1A1128" />
          </svg>
        </div>
        <div className="relative size-[15.385px]">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.3846 15.3846">
            <path d={svgStatus.p19e22200} fill="#1A1128" />
          </svg>
        </div>
        <div className="h-[15.385px] relative w-[24.038px]">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.0385 15.3846">
            <path d={svgStatus.p19d3a300} opacity="0.35" stroke="#9D94AA" strokeOpacity="0.4" strokeWidth="0.961538" fill="none" />
            <path d={svgStatus.p2a856600} fill="#1A1128" opacity="0.4" />
            <path d={svgStatus.p3ec88600} fill="#1A1128" />
          </svg>
        </div>
      </div>
    </div>
      ...
      {Array.from({ length: count }).map((_, i) => {
        ...
        return (
          <div
            ...
            style={{ width: active ? "16.97px" : "11.314px", height: active ? "16.97px" : "11.314px" }}
          >
...
function PrimaryButton({ label, onClick }: { label: string; onClick: () => void }) {
  return (
    ...
    >
      <span className="font-['Manrope',sans-serif] font-semibold text-white text-[16px] leading-none tracking-[0.4px] whitespace-nowrap" style={{ verticalAlign: "middle" }}>
        {label}
      </span>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center">
        <img alt="Lumio" className="h-[140px] w-[107px] object-cover" src={imgSplashLogo} />
      </div>
      <HomeIndicator />
    </div>
  );
  ...
  return (
    <div className="min-h-screen w-full relative flex flex-col">
      ...
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden" style={{ opacity: bgOpacity }}>
          <img
            alt=""
        ...
        <div className="w-full bg-transparent">
          <div className="w-full flex h-11 items-center justify-between px-4 py-2">
            ...
            <div className="flex gap-[2px] items-center shrink-0">
              ...
              <div className="h-[15.385px] relative w-[24.038px]">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.0385 15.3846">
                  <path d={svgStatus.p19d3a300} opacity="0.35" stroke="white" strokeOpacity="0.6" strokeWidth="0.961538" fill="none" />
        ...
        <div className="flex-1 flex flex-col justify-end px-4 pb-10 gap-[clamp(48px,10vh,120px)]">
          ...
          <div className="flex flex-col gap-2 items-center w-full">
            <div className="flex flex-col gap-2 items-center">
              <img alt="Lumio" className="h-[60px] w-[46px] object-cover" src={imgLogo} />
...
const SLIDES = [
  { bgSrc: imgBg1, bgOpacity: 1,   subtitle: "Your portfolio is your entry ticket. Let your work speak", buttonLabel: "Next" },
  { bgSrc: imgBg2, bgOpacity: 0.8, subtitle: "Learn directly from the designers who shaped the industry.", buttonLabel: "Next" },
  { bgSrc: imgBg3, bgOpacity: 0.8, subtitle: "Find roles at brands that actually vet their openings. Only verified companies.", buttonLabel: "Get Started" },
];
...
export function OnboardingPage() {
  ...
  const handleNext = () => {
    if (step === "splash") { setStep(0); return; }
