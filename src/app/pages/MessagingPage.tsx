...
import { ArrowLeft, MagnifyingGlass, Plus, DotsThreeVertical, PaperPlaneTilt } from "@phosphor-icons/react";
...
const contacts: Contact[] = [
  {
    ...
    messages: [
      ...
      { id: "2", type: "received", text: "Hey! I saw your recent post — the floral fashion comeback piece was stunning.", time: "10:20 AM" },
      { id: "3", type: "sent", text: "Thank you so much! It took a lot of research to pull together.", time: "10:22 AM" },
      { id: "4", type: "received", text: "Would love to collaborate sometime. I'm working on a similar editorial for spring.", time: "10:23 AM" },
      { id: "5", type: "sent", text: "Absolutely! DM me your portfolio and we can set up a call.", time: "10:25 AM" },
    ],
  },
  {
    id: "priya",
    ...
    messages: [
      ...
      { id: "2", type: "received", text: "Hi! Are we still on for tomorrow's call?", time: "4:00 PM" },
      { id: "3", type: "sent", text: "Yes, 11am works great for me.", time: "4:05 PM" },
      { id: "4", type: "divider", text: "Today" },
      { id: "5", type: "received", text: "Can we reschedule our call to Thursday?", time: "9:40 AM" },
    ],
  },
  {
    id: "neha",
    name: "Neha Nair",
    avatar: imgNeha,
    lastMessage: "Loved the Pitti Uomo coverage! The men's footwear trends post was 🔥",
    time: "3h",
    messages: [
      { id: "1", type: "divider", text: "Today" },
      { id: "2", type: "received", text: "Loved the Pitti Uomo coverage! The men's footwear trends post was 🔥", time: "8:15 AM" },
      { id: "3", type: "sent", text: "Glad you liked it! The brogues comeback was my fave too.", time: "8:30 AM" },
    ],
  },
  {
    id: "sneha",
    ...
    messages: [
      { id: "1", type: "divider", text: "Yesterday" },
      { id: "2", type: "sent", text: "Can you share the mood board when ready?", time: "2:00 PM" },
      { id: "3", type: "received", text: "Sent you the mood board for review.", time: "5:45 PM" },
    ],
  },
  {
    id: "chirag",
    ...
    messages: [
      ...
      { id: "2", type: "received", text: "The jackets editorial is going live Friday. Can you review?", time: "11:00 AM" },
      { id: "3", type: "sent", text: "On it! Will send feedback by EOD.", time: "11:30 AM" },
    ],
  },
  {
    id: "karan",
    ...
    messages: [
      ...
      { id: "2", type: "received", text: "Thanks for the intro to the Sabyasachi team! It really helped.", time: "6:00 PM" },
      { id: "3", type: "sent", text: "Happy to help! Good luck with the interview.", time: "6:10 PM" },
    ],
  },
];
...
function InboxView({ contacts, onOpenChat }: { contacts: Contact[]; onOpenChat: (contact: Contact) => void }) {
    ...
    <div className="flex flex-col h-full overflow-hidden">
      <div className="shrink-0 bg-[#fffeff] shadow-[0px_1px_2px_rgba(200,192,212,0.4)]">
        ...
        <div className="flex items-center gap-3 px-4 h-[52px]">
          <button onClick={() => navigate("/home/feed")} className="p-1 cursor-pointer shrink-0">
            <ArrowLeft size={18} color="#1A1128" />
          </button>
          <div className="flex-1 bg-white rounded-[4px] border border-[rgba(157,148,170,0.4)] flex items-center gap-2 px-3 h-[36px]">
            <MagnifyingGlass size={16} color="#6B5F7A" />
            <span className="font-['Manrope',sans-serif] font-normal text-[#9d94aa] text-[14px] leading-[21px]">
              Search messages
            </span>
          </div>
        </div>
        {/* Tabs row: "+" add-tab button + horizontally scrollable tabs */}
        <div className="flex items-end gap-3 px-4 pt-4 pb-2 overflow-x-auto border-b border-[#e2d9ef]" style={{ scrollbarWidth: "none" }}>
      ...
      <div className="flex-1 overflow-y-auto">
        {activeTab === "All" ? (
          contacts.map((c) => {
            const lastRealMsg = [...c.messages].reverse().find((m) => m.type !== "divider");
            ...
            >
              <img src={c.avatar} alt="" className="size-[54px] rounded-full object-cover shrink-0" />
              <div className="flex-1 min-w-0 h-[54px] flex flex-col gap-[2px] justify-center">
                <div className="flex items-center justify-between gap-2">
                  <p className="font-['Manrope',sans-serif] font-medium text-[#1a1128] text-[16px] leading-[25px] tracking-[0.16px] truncate">{c.name}</p>
                  <span className="font-['Manrope',sans-serif] font-normal text-[#6b5f7a] text-[12px] leading-[18px] tracking-[0.24px] shrink-0 whitespace-nowrap">{c.time}</span>
                </div>
                <div className="flex items-center justify-between gap-2">
                  <p className="font-['Manrope',sans-serif] font-normal text-[#6b5f7a] text-[14px] leading-[21px] truncate">{preview}</p>
                  {c.unread ? (
                    <div className="bg-[#7d3aea] flex flex-col items-center justify-center p-[8px] rounded-[200px] shrink-0 size-[26px]">
                      <span className="font-['Manrope',sans-serif] font-medium text-white text-[12px] leading-[18px] tracking-[0.24px]">{c.unread}</span>
                    </div>
                  ) : null}
                </div>
              </div>
          ...
          <div className="flex flex-col items-center justify-center gap-6 py-16 px-8">
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              <p className="font-['Manrope',sans-serif] font-semibold text-[#1a1128] text-[18px] leading-[28px]">No messages yet</p>
    ...
    <div className="flex flex-col" style={{ height: "100dvh" }}>
      <div className="bg-[#fffeff] shadow-[0px_1px_2px_rgba(200,192,212,0.4)] shrink-0">
        ...
        <div className="flex items-center gap-3 px-4 h-[60px]">
          ...
          />
          <p className="flex-1 font-['Manrope',sans-serif] font-semibold text-[#1a1128] text-[16px] leading-[25px] truncate">{contact.name}</p>
        ...
        {messages.map((msg) => {
          if (msg.type === "divider") {
            return (
              <div key={msg.id} className="flex items-center gap-3 my-1">
                ...
                <span className="font-['Manrope',sans-serif] font-normal text-[#9d94aa] text-[12px] leading-[18px] shrink-0">{msg.text}</span>
                <div className="flex-1 h-px bg-[#e2d9ef]" />
              </div>
            );
          }
          return (
            <div key={msg.id} className={`flex flex-col gap-1 ${msg.type === "sent" ? "items-end" : "items-start"}`}>
              ...
              {msg.time && (
                <span className="font-['Manrope',sans-serif] font-normal text-[#9d90ad] text-[12px] leading-[18px] tracking-[0.24px]">{msg.time}</span>
              )}
            </div>
          );
        })}
  ...
  return (
    <div className="h-screen bg-[#f0ecf7] flex items-start justify-center overflow-hidden">
      <div className="w-full max-w-[800px] min-w-0 bg-[#fffeff] flex flex-col h-full overflow-hidden">
        {activeContact ? (
          <ChatView contact={activeContact} onBack={() => setActiveContact(null)} />
        ) : (
